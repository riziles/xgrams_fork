...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"container h-full mx-auto flex justify-center items-center"}"><div class="${"space-y-10 text-center"}"><div class="${"space-y-2"}"><div>${validate_component(Typist, "Typist").$$render($$result, {}, {}, {})}</div>
